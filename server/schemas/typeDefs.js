...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        updateCourse(_id: ID!, title: String, description: String, price: Float, quiz: [ID], assignment: [ID], lessonNotes: [ID], startDate: String, endDate: String, teacher: ID, students: [ID]): Course
